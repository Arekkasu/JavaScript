...
const user = {
    ...
    Apellido: 'Lozada',
    Edad: 17,
    Pasatiempos: ['Escuchar Musica', 'Tocar Guitarra', 'Jugar Videojuegos', 'Ver anime'],
    Contact: {
...
console.log(Object.keys(user)); //Saber que contiene el objeto

console.log(Object.values(user)); //Valores que tiene el objeto

console.log(user.hasOwnProperty('nombre')); // dara true o false si el objeto contiene lo que se le pide
